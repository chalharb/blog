...
import { JOB_HISTORY } from "../constants";
import { Timeline } from "../_components/timeline";

export default function Home() {
  return (
    <>
      <section className="flex flex-wrap sm:flex-nowrap items-center my-8 md:my-16">
        ...
        <div className="flex flex-col mt-8 sm:mt-0 sm:ml-8">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            ...
            applications that have reached millions of users. I&apos;m
            passionate about leveraging different technologies to improve user
